...
#-- 10/21/2013 for Week 1 Assignment #1 Part 1
#-- For CST100 Object Oriented Software Development - 87955
#-- Instructor: Dr. Ajay Bansal

#-- First line will initialize the variable and assign the input to the variable
Faren = float(input("Please input the temperature in Fahrenheit: "))
